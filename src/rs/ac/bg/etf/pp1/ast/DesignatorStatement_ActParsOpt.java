...
public class DesignatorStatement_ActParsOpt extends DesignatorStatement {

    private Designator Designator;
    private ActParsL ActParsL;

    public DesignatorStatement_ActParsOpt (Designator Designator, ActParsL ActParsL) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatement_ActParsOpt(\n");
