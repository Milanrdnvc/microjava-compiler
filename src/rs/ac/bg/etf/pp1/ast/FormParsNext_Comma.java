...
public class FormParsNext_Comma extends FormParsNext {

    private Type Type;
    private FormParsFirst FormParsFirst;
    private FormParsNext FormParsNext;

    public FormParsNext_Comma (Type Type, FormParsFirst FormParsFirst, FormParsNext FormParsNext) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormParsNext_Comma(\n");
