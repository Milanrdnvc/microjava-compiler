...
public class MulopFactorL_MulopFactor extends MulopFactorL {

    private MulopFactorL MulopFactorL;
    private Mulop Mulop;
    private Factor Factor;

    public MulopFactorL_MulopFactor (MulopFactorL MulopFactorL, Mulop Mulop, Factor Factor) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MulopFactorL_MulopFactor(\n");
